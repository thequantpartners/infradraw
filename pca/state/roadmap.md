...
- [x] Implementación de un Superadmin Dashboard (`/admin.html`) para visualizar usuarios registrados, gestionar sus planes (FREE/PRO) y bloquear acceso a cuentas problemáticas de forma segura.
